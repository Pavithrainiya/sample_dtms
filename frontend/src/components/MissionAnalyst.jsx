        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
            ...
            {isOpen && (
                <div className="mb-4 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    {/* Quick Presets */}
                    <div className="px-4 py-2 bg-slate-100/80 border-t border-slate-200/50 flex gap-2 overflow-x-auto text-[11px] font-bold text-indigo-700">
                        <button type="button" onClick={() => setQuery("System status overview")} className="bg-white px-2.5 py-1 rounded-full border border-indigo-100 hover:bg-indigo-50 whitespace-nowrap">⚡ System Status</button>
                        <button type="button" onClick={() => setQuery("Find available Django developers")} className="bg-white px-2.5 py-1 rounded-full border border-indigo-100 hover:bg-indigo-50 whitespace-nowrap">🔍 Available Developers</button>
                    </div>
