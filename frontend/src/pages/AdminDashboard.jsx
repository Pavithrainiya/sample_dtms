...
export default function AdminDashboard() {
  ...
  const handleCreateTask = async (e) => {
    ...
    try {
      ...
      // Let Axios handle the Content-Type automatically for FormData to set the correct boundary
  ...
  const handleDeleteTask = async (id) => {
    console.log('🗑️ Delete button clicked for task ID:', id);
    ...
    try {
      ...
      // Direct high-clearance deletion path
      ...
      <aside className="w-64 bg-slate-900 shadow-xl flex flex-col hidden lg:flex z-10 text-slate-100">
        <div className="p-6 border-b border-slate-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xl font-black text-white tracking-tight">System Administrator</span>
          </div>
